...
const galleryItems: GalleryItem[] = [
  { 
    id: 1, 
    src: 'https://res.cloudinary.com/dmy7kknrc/image/upload/v1774243614/WhatsApp_Image_2026-03-23_at_10.54.49_AM_3_zzvrjm.jpg', 
    title: 'Rose Collection', 
    description: 'Beautiful red rose bouquet with matching scrunchie and bow keychain' 
  },
  { 
    id: 2, 
    src: 'https://res.cloudinary.com/dmy7kknrc/image/upload/v1774243624/WhatsApp_Image_2026-03-23_at_10.54.49_AM_2_ekzhif.jpg', 
    title: 'Work in Progress', 
    description: 'Handcrafting a red scrunchie with love and care' 
  },
  { 
    id: 3, 
    src: 'https://res.cloudinary.com/dmy7kknrc/image/upload/v1774243632/WhatsApp_Image_2026-03-23_at_10.54.49_AM_1_itxlsa.jpg', 
    title: 'Sunny Sunflower', 
    description: 'Cheerful yellow sunflower in a handmade pot' 
  },
  { 
    id: 4, 
    src: 'https://res.cloudinary.com/dmy7kknrc/image/upload/v1774243640/WhatsApp_Image_2026-03-23_at_10.54.49_AM_ey6nst.jpg', 
...
const products: Product[] = [
  { 
    ...
    image: 'https://res.cloudinary.com/dmy7kknrc/image/upload/v1774243614/WhatsApp_Image_2026-03-23_at_10.54.49_AM_3_zzvrjm.jpg',
    category: 'flowers',
  ...
  { 
    ...
    image: 'https://res.cloudinary.com/dmy7kknrc/image/upload/v1774243624/WhatsApp_Image_2026-03-23_at_10.54.49_AM_2_ekzhif.jpg',
  ...
  { 
    ...
    image: 'https://res.cloudinary.com/dmy7kknrc/image/upload/v1774243632/WhatsApp_Image_2026-03-23_at_10.54.49_AM_1_itxlsa.jpg',
    category: 'flowers',
  ...
  { 
    ...
    image: 'https://res.cloudinary.com/dmy7kknrc/image/upload/v1774243640/WhatsApp_Image_2026-03-23_at_10.54.49_AM_ey6nst.jpg',
    category: 'amigurumi',
              ...
              <motion.div variants={fadeInUp} className="relative z-10">
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={() => setIsContactOpen(true)}
                    className="px-6 py-3 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full text-white font-semibold flex items-center gap-2 shadow-lg"
                  >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={() => setIsContactOpen(true)}
                    className="px-6 py-3 bg-blue-500 rounded-full text-white font-semibold flex items-center gap-2 shadow-lg"
                  >
      ...
      <Dialog open={isContactOpen} onOpenChange={setIsContactOpen}>
        <DialogContent className="max-w-md rounded-3xl">
          ...
          <div className="space-y-4 mt-4">
            ...
            <motion.button
              onClick={() => {
                window.open('https://instagram.com/_crochet_arts_', '_blank');
                setIsContactOpen(false);
              }}
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-r from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 transition-colors"
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full flex items-center gap-4 p-4 rounded-2xl bg-blue-50 hover:bg-blue-100 transition-colors"
            >
